...
extern u8 Flag_Stop,Flag_Show,Flag_Zero;      //停止标志位和 显示标志位 默认停止 显示打开
...
extern u8 delay_50,delay_flag,sudu;                          //延时相关变量
extern u8 Turn_Flag,PID_Send;  //CAN和串口控制相关变量
...
extern float	Balance_Kp,Balance_Kd,Balance_Kp1,Balance_Kd1,Velocity_Kp,Velocity_Ki,Velocity_Kp1,Velocity_Ki1,Turn_Kp,Turn_Kd;  //控制PID参数
